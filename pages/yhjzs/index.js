...
Page({
  ...
  onLoad: function (options) {
    ...
    var that = this;
    var url = app.globalData.url + '/user/coupanInfo';
    var data = {
      id: options.id,
    }
  ...
  sublinqu:function(e){
    ...
    app.wxRequest('POST', url, data, (res) => {
      ...
      if (res.code == 1) {
        ...
        var url1 = app.globalData.url + '/user/coupanInfo';
        var data1 = {
          id: that.data.id,
        }
  ...
  onShareAppMessage: function () {
    ...
    return {
      ...
      path: 'pages/yhjzs/index?id=' + that.data.goshop_index.id + '&pid=' + 1
    };
  }
})
